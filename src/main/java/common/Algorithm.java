...
public class Algorithm {
    ...
    HashMap<String, Directory> hm = new HashMap<>();
    ...
    public void addWord() {
        ...
        Directory directoryModel = new Directory(english, vietnamese);
    ...
    public void translate() {
        ...
        switch (choice) {
            case 1:
                System.out.print("Enter Vietnamese: ");
                String vietnamese = validation.checkInputString();
                Directory directoryModelEng = hm.get(vietnamese);
            ...
            case 2:
                ...
                String english = validation.checkInputString();
                boolean found = false;
                for (Directory directoryModel : hm.values()) {
